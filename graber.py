...
def grab():
    #模拟登录
    browser = webdriver.Chrome(executable_path=os.path.join(path,'chromedriver'))
    ...
    #选择轮次
    browser.find_element_by_css_selector("body > div.jqx-rc-all.jqx-window.jqx-popup.jqx-widget.jqx-widget-content > div.jqx-window-content.jqx-widget-content.jqx-rc-b > div.content > div > div > table > tbody").click()
